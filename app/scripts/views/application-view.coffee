class shuttledriveWeb.Views.ApplicationView extends Backbone.View
    ...
    render: ->
        ...
        $("#departure_start, #departure_end, #arrival_start, #arrival_end").timepicker({amPmText: ['', '']})
    ...
    createOnSubmit: ->
        ...
        tripRequest = new shuttledriveWeb.Models.TripRequestModel({start_time_min: dep_start, start_time_max: dep_end, end_time_min: arr_start, end_time_max: arr_end})
